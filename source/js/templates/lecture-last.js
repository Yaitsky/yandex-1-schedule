var Handlebars = require("handlebars");module.exports = Handlebars.template({"1":function(depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"schedule__row\">\n    <div class=\"schedule__col schedule__col--wide\">\n        <a href=\""
    ...
    + alias3(((helper = (helper = helpers.school || (depth0 != null ? depth0.school : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"school","hash":{},"data":data,"blockParams":blockParams}) : helper)))
    + "</div>\n    <div class=\"schedule__col\">\n"
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.teacher : depth0),{"name":"each","hash":{},"fn":this.program(1, data, 1, blockParams),"inverse":this.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </div>\n    <div class=\"schedule__col\">"
